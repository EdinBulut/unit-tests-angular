...
describe('AppComponentoo', () => {
  ...
  it ('testing sum 2 nums', () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    // const isSumFworking =  app.sumTwoNums(10, 20) === 30;
    // expect(isSumFworking).toBeTrue()
    expect(app.sumTwoNums(10, 20)).toBe(30);
  })
});
